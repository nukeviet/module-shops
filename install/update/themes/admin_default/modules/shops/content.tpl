    ...
    <div class="row">
        <div class="col-sm-24 col-md-18">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-20">
                                <div class="input-group">
                                    <input class="form-control" name="alias" type="text" id="idalias" value="{rowcontent.alias}" maxlength="255" /> <span class="input-group-btn">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-8">
                                ...
                                <!-- END: edit -->
                                <!-- BEGIN: add -->
                                <input class="form-control" type="number" min="0" maxlength="50" value="{rowcontent.product_number}" name="product_number" />
                                <!-- END: add -->
                            </div>
                            <!-- END: warehouse -->
                        </div>
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div class="form-group">
                        <div class="input-group">
                            <input class="form-control" type="text" name="homeimg" id="homeimg" value="{rowcontent.homeimgfile}" /> <span class="input-group-btn">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    {LANG.content_hometext} <span class="require">(*)</span> {LANG.content_notehome}
                </div>
                <div class="panel-body" id="hometext">{edit_hometext}</div>
            </div>
            <div class="panel panel-default">
                <div class="panel-heading">
                    {LANG.content_bodytext} <span class="require">(*)</span> {LANG.content_notehome}
                </div>
                <div class="panel-body" id="bodytext">{edit_bodytext}</div>
            </div>
            <!-- BEGIN: files -->
            <div class="panel panel-default">
                        ...
                        <div class="col-xs-24 col-sm-12">
                            <div class="col-xs-24" style="margin-bottom: 5px">
                                <div class="row">
                                    ...
                                    <div class="col-xs-6">
                                        <select class="form-control" name="gift_from_h" style="width: 100%"> {gift_from_h}
                                        </select>
                                    </div>
                                    <div class="col-xs-6">
                                        <select class="form-control" name="gift_from_m" style="width: 100%"> {gift_from_m}
                                        </select>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xs-24">
                                <div class="row">
                                    ...
                                    <div class="col-xs-6">
                                        <select class="form-control" name="gift_to_h" style="width: 100%"> {gift_to_h}
                                        </select>
                                    </div>
                                    <div class="col-xs-6">
                                        <select class="form-control" name="gift_to_m" style="width: 100%"> {gift_to_m}
                                        </select>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="col-sm-24 col-md-6">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">{row_block}</div>
            </div>
            <!-- END:block_cat -->
            <div class="panel panel-default">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    {LANG.content_publ_date} <span class="timestamp">{LANG.content_notetime}</span>
                </div>
                <div class="panel-body">
                    <div class="form-group">
                        <div class="input-group">
                            <input class="form-control" name="publ_date" id="publ_date" value="{publ_date}" maxlength="10" type="text" /> <span class="input-group-btn">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    {LANG.content_exp_date} <span class="timestamp">{LANG.content_notetime}</span>
                </div>
                <div class="panel-body">
                    <div class="form-group">
                        <div class="input-group">
                            <input class="form-control" name="exp_date" id="exp_date" value="{exp_date}" maxlength="10" type="text" /> <span class="input-group-btn">
                    ...
                    <div style="margin-top: 5px;">
                        <input type="checkbox" value="1" name="archive" {archive_checked} /> <label>{LANG.content_archive}</label>
                    </div>
                </div>
            </div>
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <div style="margin-bottom: 2px;">
                        <input type="checkbox" value="1" name="inhome" {inhome_checked}/> <label>{LANG.content_inhome}</label>
                    </div>
                    <div style="margin-bottom: 2px;">
                        <input type="checkbox" value="1" name="allowed_rating" {allowed_rating_checked}/> <label>{LANG.content_allowed_rating}</label>
                    </div>
                    <div style="margin-bottom: 2px;">
                        <input type="checkbox" value="1" name="allowed_send" {allowed_send_checked}/> <label>{LANG.content_allowed_send}</label>
                    </div>
                    <div style="margin-bottom: 2px;">
                        <input type="checkbox" value="1" name="allowed_print" {allowed_print_checked} /> <label>{LANG.content_allowed_print}</label>
                    </div>
                    <div style="margin-bottom: 2px;">
                        <input type="checkbox" value="1" name="allowed_save" {allowed_save_checked} /> <label>{LANG.content_allowed_save}</label>
                    </div>
                    <div style="margin-bottom: 2px;">
