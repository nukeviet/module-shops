# Hướng dẫn cập nhật module SHOPS từ 4.3.00 lên 4.5.00
...
- Module SHOPS 4.5.02 hoạt động trên NukeViet 4.5.02
...
Tải gói cập nhật tại https://github.com/nukeviet/module-shops/archive/refs/heads/to-4.5.02.zip. Giải nén và upload thư mục install lên ngang hàng với thư mục install trên server. Đăng nhập quản trị site, nhận được thông báo cập nhật và tiến hành cập nhật theo hướng dẫn của hệ thống.
