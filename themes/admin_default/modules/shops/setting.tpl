...
<form class="form-inline" action="" method="post">
    <div class="table-responsive">
        <table class="table table-striped table-bordered table-hover">
            <caption>{LANG.content_extra}</caption>
            <colgroup>
                <col class="w500" />
            </colgroup>
            <tbody>
                ...
                <tr id="download_groups"
                    ...
                    style="display: none"
                    <!-- END: download_groups_none -->
                    >
                    <td><strong>{LANG.download_setting_groups}</strong></td>
                    <td>
                        <!-- BEGIN: download_groups --> <label class="show"><input name="download_groups[]" type="checkbox" value="{DOWNLOAD_GROUPS.value}" {DOWNLOAD_GROUPS.checked} />{DOWNLOAD_GROUPS.title}</label> <!-- END: download_groups -->
                    </td>
                </tr>
            </tbody>
        </table>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        <div class="row">
                            <div class="col-xs-12">
                                <select class="form-control" name="home_data" style="width: 100%">
                                    <!-- BEGIN: home_data_loop -->
                                    <option value="{HOME_DATA.index}"{HOME_DATA.selected}>{HOME_DATA.value}</option>
                                    <!-- END: home_data_loop -->
                                </select>
                            </div>
                            <div class="col-xs-12">
                                <select class="form-control" name="home_view" style="width: 100%">
                ...
                <tr>
                    ...
                    <td><select class="form-control" name="per_row">
                            <!-- BEGIN: per_row -->
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><select class="form-control" name="money_unit">
                            <!-- BEGIN: money_loop -->
                ...
                <tr>
                    ...
                    <td><select class="form-control" name="weight_unit">
                            <!-- BEGIN: weight_loop -->
                ...
                <tr>
                    ...
                    <td><select name="sortdefault" class="form-control w200">
                            <!-- BEGIN: sortdefault -->
    ...
    <div class="table-responsive" id="setting_group_price">
        <table class="table table-striped table-bordered table-hover">
            <caption>{LANG.setting_active_order}</caption>
            <colgroup>
                <col class="w500" />
            </colgroup>
            <tbody>
        ...
        <table class="table table-striped table-bordered table-hover">
            ...
            <tbody>
                <tr>
                    ...
                    <td><textarea class="form-control" name="group_price" rows="9" style="width: 100%">{DATA.group_price}</textarea></td>
                </tr>
            </tbody>
        </table>
    </div>
