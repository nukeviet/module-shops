...
// Cập nhật sql fix lỗi vào cấu hình module bị trắng trang
$sql_create_module[] = "ALTER TABLE " . NV_GROUPS_GLOBALTABLE . " ADD title VARCHAR(250) NOT NULL AFTER group_id";
